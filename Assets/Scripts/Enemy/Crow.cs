...
public class Crow : EnemyBasic
{
    ...
    IEnumerator LRShot()
    {
        Vector3 targetPos = enemyStatus.EnemyTarget.CenterPivot.position;
        ...
        {
            // 공격 시작 할 때 적의 위치
            targetPos = enemyStatus.EnemyTarget ? enemyStatus.EnemyTarget.CenterPivot.position : targetPos;
